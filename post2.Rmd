...
This data story focus on the covid cases and deaths that occurred due to it in **Bahrain**, with respect to the continent it is in which is **Asia**.
...
* Surprisingly **China** doesn't show up in this stats even being the world's populous country.( refer [here](https://covid19.who.int/region/wpro/country/cn))
...
This data story focus on the covid cases and deaths that occurred due to it in **Bahrain**, with respect to country with maximum cases in each continent.
...
*  Bahrain as showed the same trend for both years as mentioned above, but it recorded least cases only in **March,2021**.
