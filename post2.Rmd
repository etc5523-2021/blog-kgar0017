...
This data story focus on the covid cases and deaths that occured due to it in **Bahrain**, with respect to country with maximum cases in each conntinent.
...
covid %>% 
  ...
  theme(legend.position = "none")
```
The above plot showcase the countries with maximum covid cases in each continent and compare them to **Bahrain**.

*  Suprisingly, **United States** recorded more cases than **India** even being less populated.
*  **Bahrain**, this time when compared across continents tuened out to have shift its place from least cases recorded to second least with **Australia** recording the least Covid cases across the continent wise comparison.
...
*  Bahrain as showed the same trend for both years as mentioned above, but it recorded least cxases only in **March,2021**.
*  After **March,2021**, it Australia who took the seat of having the least coses and remained constant till **June,2021**,
* It is only after **June,2021**, when an outbreak happened in Australia, cases shoot up and Bahrain was back to the least recorded for the folowwig months.
*  **India** and **US** were pretty much neck-to-neck in cases recorded upto **October,2020**, after that cases in US saw whopping jump and remained same for **3 months**. Soon after **January,2021**, fall in cases recorded was observed and on other hand, India went to its peak of coviid cases recorded in **May,2021**. 
...
*  In **2021**, though India recorded most in a month, but overall it brazil who jumped to its peak in **April** similar to India but the fall in cases was gradual unlike which drastically dropped in cases eiing recorded.
