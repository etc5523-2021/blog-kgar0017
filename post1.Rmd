...
*  In **2020**, the increase in covid cases was pretty much stead and saw a gradual increase after the month **5** and reached to it's peak in **9th month** with a total of **`r case_2020_max$Mon_new_cases`** alone in this month. 
*  The bove point seems to be pretty true also as India was in full lockdown till the end of **May 2020**, after which we only see a gradual increase in cases.
*  In **2021**, cases started increasing in **2nd month**, but saw a showcking rise after the **3rd month** (in-time, when the **2nd wave** of covid kicked in) and reach to it's all time high of **`r case_2021_max$Mon_new_cases`** alone in **5th month**, after which t again dropped drastically to almost same to it's total in **2nd month**.
