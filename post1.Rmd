...
*  In **2021**, cases started increasing after **February**, but saw a showcking rise after the **March** (in-time, when the **2nd wave** of covid kicked in) and reach to it's all time high of **`r case_2021_max$Mon_new_cases`** alone in **May**, after which it again dropped drastically to almost same to it's total in **February**.
...
*  In **2020**, max deaths **`r death_2020_max$Mon_new_deaths`** were recordrd in **September**.
*  In **2021**, max deaths **`r death_2021_max$Mon_new_deaths`** were recordrd in **May**.
...
*  No vaccinations were done in 2021 ( which is true as vaccine started to be distriuted in **2021**).
*  In **2021**, we oserve an exponential rise in **1st dose** delivered after **"February"** and a gradual rise in **2nd dose** done, but a sudden dip in vaccinations is seen in period **April-May** for 1st dose and **May-June** for 2nd dose. This maybe duw to global shortage of vaccines.
*  The vaccine drive saw another quick jump in doses being given im **July,2021** and then again saw a fall.